...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jscpd/node_modules/jscpd/lib/map.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jscpd/node_modules/jscpd/lib/map.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jscpd/node_modules/jscpd/lib/</a> &#187; map.js</div>
</div>
<div class="body">
...
&nbsp;
    Map.prototype.getPercentage = function() {
      var result;
      result = 0;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.numberOfLines &gt; 0) {
