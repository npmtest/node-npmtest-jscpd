...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-jscpd/node_modules/jscpd/lib/reporters/xml-pmd.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-jscpd/node_modules/jscpd/lib/reporters/xml-pmd.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-jscpd/node_modules/jscpd/lib/reporters/</a> &#187; xml-pmd.js</div>
</div>
<div class="body">
...
&nbsp;
  module.exports = function(options) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options['xsl-href']) {
<span class="cstat-no" title="statement not covered" >      xmlDoc += '&lt;?xml-stylesheet type="text/xsl" href="' + options['xsl-href'] + '"?&gt;';</span>
    }
    xmlDoc += '&lt;pmd-cpd&gt;';
    ref = this.map.clones;
    fn = function(clone) {
